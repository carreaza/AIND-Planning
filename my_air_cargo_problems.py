...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
            ...
            for airport in self.airports:
                for plane in self.planes:
                    for cargo in self.cargos: 
                        precondition_pos= [expr("At({},{})".format(cargo,airport)),expr("At({},{})".format(plane,airport))]
                        precondition_neg = []
        ...
        def unload_actions():
            ...
            for airport in self.airports:
                for plane in self.planes:
                    for cargo in self.cargos:
                        precondition_pos= [expr("In({},{})".format(cargo,plane)),expr("At({},{})".format(plane,airport))]
                        precondition_neg = []
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        count = len(set(self.goal) - current_state)
        return count
